...
TabListManager.prototype.checkOptions = function(passedOptions) {
    ...
    this.getBookmarksTree(options.folderID, this.setupTabLists);
...
TabListManager.prototype.getBookmarksTree = function(id, callback) {
...
} // end TabListManager.getBookmarksTree

TabListManager.prototype.setupTabLists = function(bookmarkTree) {
